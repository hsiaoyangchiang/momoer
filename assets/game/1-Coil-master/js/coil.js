...
var Coil = (function(){
	...
	var ENEMY_COUNT = 3; //change this for difficulty
		ENEMY_SIZE = 10; //has little to do with it
	...
	var SCORE_PER_ENEMY = 30, //lower score for quicker death
		SCORE_PER_TICK = 0.01;
	
	var ENERGY_PER_ENEMY_DEATH = -30, //higher score for quicker death
		ENERGY_PER_ENEMY_ENCLOSED = 1, //lower energy for quicker death
		ENERGY_PER_BOMB_ENCLOSED = -30; //higher score for quicker death
