    ...
    <body>
        ...
        <div class="modal-signup">
            <form class="form-signup">
                <button type="button" id="close-signup">Close</button> <!--要記錄使用者資料嗎？感覺毛毛：）-->

                <label for="account">Account</label>
                <input type="text" id="account" name="account" placeholder="請輸入電子信箱" ></input>
                <label for="password">Password</label>
                <input type="password" id="password" name="password" placeholder="請輸入密碼"></input>
                <label for="username">Display Name</label>
                <input type="text" id="username" name="username" placeholder="請輸入顯示名稱"></input>

                <label for="toc">使用條款</label>
                <textarea name="toc" class="textarea-toc" disabled>
                ...
                <div><input type="checkbox" id="agree_toc" name="agree_toc" value="1"></input>
                <label for="agree_toc"> 我已同意上述使用條款</label></div>
